import { Bn as HalfFloatType, Bs as Vector3, Js as WebGLRenderTarget, Oo as ShaderMaterial, Vs as Vector4, i as UniformsLib, ii as Mesh, ks as UniformsUtils, na as PerspectiveCamera, ni as Matrix4, ra as Plane, st as Color } from "./three.module-BKY27AXr.js";
//#region node_modules/three/examples/jsm/objects/Water.js
/**
	...
	*/
	constructor(geometry, options = {}) {
		...
		*/
		...
		const sunDirection = options.sunDirection !== void 0 ? options.sunDirection : new Vector3(.70707, .70707, 0);
		...
		const side = options.side !== void 0 ? options.side : 0;
		...
		const mirrorShader = {
			...
			uniforms: UniformsUtils.merge([
				...
				UniformsLib["lights"],
				{
					...
					"sunDirection": { value: new Vector3(.70707, .70707, 0) },
		...
		scope.onBeforeRender = function(renderer, scene, camera) {
			...
			if (viewport !== void 0) renderer.state.viewport(viewport);
		};
	}
};
//#endregion
