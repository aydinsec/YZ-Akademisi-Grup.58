//#region node_modules/three/examples/jsm/libs/lil-gui.module.min.js
/**
* lil-gui
...
var h = class extends t {
	constructor(t, i, e) {
		...
		}), this.$button.addEventListener("touchstart", () => {}, { passive: !0 }), this.$disable = this.$button;
	}
};
var d = class extends t {
	...
	_initInput() {
		...
		}, { passive: !1 }), this.$input.addEventListener("mousedown", (t) => {
	...
	_initSlider() {
		...
		this.$slider.addEventListener("mousedown", (s) => {
			...
			t.touches.length > 1 || (this._hasScrollBar ? (s = t.touches[0].clientX, n = t.touches[0].clientY, l = !0) : r(t), window.addEventListener("touchmove", o, { passive: !1 }), window.addEventListener("touchend", a));
		}, { passive: !1 }), this.$slider.addEventListener("wheel", (t) => {
...
var g = class g {
	...
	add(t, e, s, n, l) {
		...
		const r = t[e];
		switch (typeof r) {
			case "number": return new d(this, t, e, s, n, l);
			case "boolean": return new i(this, t, e);
			case "string": return new u(this, t, e);
			case "function": return new h(this, t, e);
		}
...
//#endregion
export { i as BooleanController, a as ColorController, t as Controller, h as FunctionController, g as GUI, g as default, d as NumberController, c as OptionController, u as StringController };
